...
class TTS:
  ...
  def synthesize(self, text_to_synthesize="This is an audio test."):
    ...
    print(f"Converted input text to tensor \"{text_to_synthesize}\" -> Tensor({stn_tst.shape}): {stn_tst.numpy()}") #TODO: logging
