...
class BrainTrigger:
  ...
  def check_chat_request(self, text: str) -> bool:
    ...
    return (
      True
      if TriggerList.chat_start in tokens and any(keyword in tokens for keyword in TriggerList.chat_check)
      else False
    )
  ...
  def check_browse_request(self, text: str) -> bool:
    ...
    return (
      True
      if TriggerList.browse_start in tokens and any(keyword in tokens for keyword in TriggerList.browse_check)
      else False
    )
  ...
  def check_summarize_request(self, text: str) -> bool:
    ...
    return (
      True
      if TriggerList.summarize_start in tokens and any(keyword in tokens for keyword in TriggerList.summarize_check)
      else False
    )
  ...
  def check_explain_request(self, text: str) -> bool:
    ...
    return (
      True
      if TriggerList.explain_start in tokens and any(keyword in tokens for keyword in TriggerList.explain_check)
      else False
    )
  ...
  def check_audio_request(self, text: str) -> bool:
    ...
    return (
      True
      if TriggerList.audio_start in tokens and any(keyword in tokens for keyword in TriggerList.audio_check)
      else False
    )
