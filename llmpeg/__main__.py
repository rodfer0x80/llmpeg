...
class Main:
  ...
  def run(self):
    self.agent = Agent(conversation_model=self.conversation_model, nlp_model=self.nlp_model, tts_model_size=self.tts_model_size, stt_model_size=self.stt_model_size,)
